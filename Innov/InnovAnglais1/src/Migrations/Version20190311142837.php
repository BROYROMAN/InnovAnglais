 ...
 */
final class Version20190311142837 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire ADD nomoriginal VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire DROP nomoriginal, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
