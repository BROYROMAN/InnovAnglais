 ...
 */
final class Version20190311142443 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire DROP nomoriginal, CHANGE user_id user_id INT DEFAULT NULL, CHANGE taille taille DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire ADD nomoriginal VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE user_id user_id INT DEFAULT NULL, CHANGE taille taille INT NOT NULL');
    }
}
