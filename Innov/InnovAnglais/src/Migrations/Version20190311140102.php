 ...
 */
final class Version20190311140102 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire ADD date DATETIME NOT NULL, ADD extension VARCHAR(255) NOT NULL, ADD taille INT NOT NULL, ADD nomoriginal VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vocabulaire DROP date, DROP extension, DROP taille, DROP nomoriginal, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
